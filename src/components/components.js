...
render(){
    return(
        <div>
            <p style={{textAlign: "center"}}> this is our count: {this.state.counter} </p>
            <button onClick={this.increment}>Increment </button>
            <button onClick={this.decrement}>Decrement</button>
          
             <center>
            <button style={{textAlign: "center"}} onClick={()=>this.image()}> <img style={{height: "200px", width: "200px",}} src={this.state.img}  alt="no" /> </button> 
            </center>
